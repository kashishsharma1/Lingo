  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
       ...
       primary: "bg-sky-400 text-primary-foreground hover: bg-sky-500/90 border-sky-600 border-b-4 active:border-b-0",
       primaryOutline: "bg-white text-sky-500 hover:bg-slate-100",
       secondary: "bg-green-500 text-primary-foreground hover: bg-green-600/90 border-green-700 border-b-4 active:border-b-0",
       secondaryOutline: "bg-white text-green-500 hover:bg-slate-100",
       danger: "bg-rose-500 text-primary-foreground hover: bg-rose-600/90 border-rose-700 border-b-4 active:border-b-0",
       dangerOutline: "bg-white text-rose-500 hover:bg-slate-100",
       super: "bg-indigo-500 text-primary-foreground hover: bg-indigo-600/90 border-indigo-800 border-b-4 active:border-b-0",
       ...
       sidebarOutline: "bg-sky-500/15 <text-sky-6></text-sky-6>00 border-sky-400 border-2 border-2 hover:bg-sky-500/20 transition-none",
